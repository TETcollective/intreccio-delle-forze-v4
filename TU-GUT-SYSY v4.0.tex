...
\[
G(Q) = \frac{G_0}{1 + \xi \ln(Q^2/M_{\text{Pl}}^2)}
\]
...
A Q << M_Pl, α_g ≈ costante piccola (GR classica).  
A Q → M_Pl, α_g cresce → gravità “forte” a scala Planck, analoga al confinamento QCD.

Questo running completa il mio α_tot(s): la gravità è il contributo dominante a bassa energia cosmica, debole a alta energia – proprio come previsto dal tessuto multiscalare.
